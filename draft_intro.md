...
2.  **Chapter 2: Your First Module** — Writing a simple image blur module in C++ using the `GEF_MODULE` macro. You'll learn the basic structure of an Atomic Module and how to implement the `execute` function.
